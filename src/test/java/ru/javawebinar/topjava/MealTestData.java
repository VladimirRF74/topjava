...
public class MealTestData {
    ...
    public static final Meal meal5 = new Meal(MEAL_ID + 4, of(2020, Month.JANUARY, 31, 10, 0), "Завтрак", 1000);
    public static final Meal meal6 = new Meal(MEAL_ID + 5, of(2020, Month.JANUARY, 31, 13, 0), "Обед", 500);
    public static final Meal meal7 = new Meal(MEAL_ID + 6, of(2020, Month.JANUARY, 31, 20, 0), "Ужин", 410);
    ...
    public static Meal getNew() {
        return new Meal(null, of(2022, Month.JUNE, 19, 20, 0), "Новый ужин", 300);
    }

    public static Meal getUpdated() {
        return new Meal(MEAL_ID, meal1.getDateTime().plus(2, ChronoUnit.MINUTES), "Обновленный завтрак", 250);
    }
